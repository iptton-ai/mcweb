...
被投料口守卫 N16 拦截，沙物品停驻投料口、T 为空，线自然停在末端——「≥2 轮无人值守」
达成且有限幅）。
**G3 勘误（2026-09-06）**：本摆位应力 = 粉碎对 64 + 投料器 16 + 带 8 = 88 SU > 单水车
容量 64，**须双水车（128 SU）**——E2E 按双水车验证通过；沙终态为物品实体非方块
（N16 守卫，见 org-log 清单缺陷处理条目）。
