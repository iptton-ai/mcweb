...
// 布局自检要点（对应 _lib 校验器）：
//   - 主通路全部 6 邻可达：楼梯=逐格 +1 实心台阶，楼板洞开在最后两级头顶（2 宽）。
...
export function buildLevel() {
    ...
    c.clear(22, gy + 5, 24, 22, gy + 5, 25);                // 楼板洞：开在最后两级头顶（2 宽）
    ...
    // 锁③隔墙（x=34，z 11..28，封到屋顶）：yuwen 字词两步推理
    c.fill(34, gy + 6, 11, 34, gy + 9, 28, BRICK);
    ...
    c.clear(21, gy + 10, 14, 21, gy + 10, 15);              // 屋顶洞：最后两级头顶（2 宽）
